...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.img_infos = self.load_annotations(self.img_dir, self.img_suffix,
                                               self.ann_dir,
                                               self.seg_map_suffix, self.split, self.depth_dir, self.depth_suffix)
    ...
    def load_annotations(self, img_dir, img_suffix, ann_dir, seg_map_suffix,
                         split, depth_dir=None, depth_suffix=None):
        ...
        if split is not None:
            ...
            for img in mmcv.scandir(img_dir, img_suffix, recursive=True):
                ...
                if ann_dir is not None:
                    ...
                    img_info['ann'] = dict(seg_map=seg_map)
                if depth_dir is not None:
                    depth_map = img.replace(img_suffix, depth_suffix)
                    img_info['depth'] = dict(depth_map=depth_map)
                # print(img_info)
                img_infos.append(img_info)
    ...
    def prepare_train_img(self, idx):
        ...
        depth_info = self.get_depth_info(idx) if self.depth_dir is not None else None
